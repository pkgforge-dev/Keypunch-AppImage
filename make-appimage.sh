...
export STARTUPWMCLASS=dev.bragefuglseth.Keypunch.desktop # Default to Wayland's wmclass. For X11, GTK_CLASS_FIX will force the wmclass to be the Wayland one.
